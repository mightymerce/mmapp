...
module.exports = function (app) {
  ...
  app.route('/api/paypal/paypalSetExpressCheckout/:USER/:PWD/:SIGNATURE/:returnUrl/:cancelUrl/:brandName/:brandLogoUrl/:productName/:productDescription/:productQuantity/:cartAmount/:buyerMail/:productCurrency/:cartShippingAmount/:productItemAmount/:productNo/:cartSubtotalAmount').all(checkoutsPolicy.isAllowed)
