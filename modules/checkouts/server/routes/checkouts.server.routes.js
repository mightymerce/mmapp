...
module.exports = function (app) {
  ...
  app.route('/api/paypal/paypalSetExpressCheckout/:USER/:PWD/:SIGNATURE/:brandName/:brandLogoUrl/:productName/:productDescription/:productQuantity/:cartAmount/:buyerMail/:productCurrency').all(checkoutsPolicy.isAllowed)
