  ...
  function ($locationProvider, $httpProvider, $translateProvider) {
    ...
    $httpProvider.interceptors.push('authInterceptor');
      ...
      $translateProvider.translations('de-DE', {
        ...
        'NOTE-PROVIDE-COMPANY-DETAILS':'Bitte ergänze deine Firmendaten und halte sie aktuell, damit wir dir monatlich eine gültige Rechnung ausstellen können. Aktuell sind nur Addressen in Deutschland möglich.',
      ...
      $translateProvider.translations('en-EN', {
          ...
          'NOTE-PROVIDE-COMPANY-DETAILS':'For the receipt of a monthly invoice, please provide your company’s address details (so far only addresses in Germany are valid.',
