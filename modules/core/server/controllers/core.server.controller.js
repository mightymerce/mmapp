...
exports.sendmail = function (req, res) {
  ...
  html = html + '	<title>Bestellung</title>		';
  ...
  html = html + '	<div class="emailSummary" style="mso-hide: all;display: none !important;font-size: 0 !important;max-height: 0 !important;line-height: 0 !important;padding: 0 !important;overflow: hidden !important;float: none !important;width: 0 !important;height: 0 !important;">Wir freuen uns über Ihre Bestellung vom <strong>' + inputData.orderDate + '</strong>.</div>		';
  html = html + '	<div class="emailSummary" style="mso-hide: all;display: none !important;font-size: 0 !important;max-height: 0 !important;line-height: 0 !important;padding: 0 !important;overflow: hidden !important;float: none !important;width: 0 !important;height: 0 !important;">Ihre Bestellnummer: <strong>' + inputData.orderId + '</strong>.</div>		';
  ...
  html = html + '	            <p style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 24px;padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;font-size: 14px;line-height: 22px;text-align: left;">Wir freuen uns über Ihre Bestellung vom <strong>' + inputData.orderDate + '</strong>.</p>		';
  html = html + '	            <p style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 24px;padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;font-size: 14px;line-height: 22px;text-align: left;">Ihre Bestellnummer: <strong>' + inputData.orderId + '</strong>.</p>		';
  ...
  html = html + '	                    <tr>		';
  html = html + '	                      <td align="left" valign="middle" class="tagName" style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 0;padding-top: 4px;padding-bottom: 4px;padding-left: 6px;padding-right: 6px;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;text-align: left;font-size: 11px;color: #ffffff;background-color: #cbcbcb;text-transform: uppercase;white-space: nowrap;">Anschrift</td>		';
  html = html + '	                    </tr>		';
  html = html + '	                    <tr>		';
  ...
  html = html + '	                    <tr>		';
  html = html + '	                      <td align="left" valign="middle" class="tagName" style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 0;padding-top: 4px;padding-bottom: 4px;padding-left: 6px;padding-right: 6px;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;text-align: left;font-size: 11px;color: #ffffff;background-color: #cbcbcb;text-transform: uppercase;white-space: nowrap;">Zahlung</td>		';
  html = html + '	                    </tr>		';
  html = html + '	                    <tr>		';
  html = html + '	                      <td class="tag_space emptyCell" style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 0;padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;text-align: left;font-size: 0 !important;color: #898989;background-color: transparent;line-height: 0 !important;height: 4px;">&nbsp;</td>		';
  html = html + '	                    </tr>		';
  ...
  html = html + '	                    <tr>		';
  html = html + '	                      <td align="left" valign="middle" class="tagName" style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 0;padding-top: 4px;padding-bottom: 4px;padding-left: 6px;padding-right: 6px;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;text-align: left;font-size: 11px;color: #ffffff;background-color: #cbcbcb;text-transform: uppercase;white-space: nowrap;">Lieferung</td>		';
  html = html + '	                    </tr>		';
  html = html + '	                    <tr>		';
  html = html + '	                      <td class="tag_space emptyCell" style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 0;padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;text-align: left;font-size: 0 !important;color: #898989;background-color: transparent;line-height: 0 !important;height: 4px;">&nbsp;</td>		';
  html = html + '	                    </tr>		';
  html = html + '	                  </table>		';
  html = html + '	                  <p class="amount" style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 24px;padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;color: #242424;font-size: 12px;line-height: 19px;text-align: left;">' + inputData.orderShippingTime + ' </p></td>		';
  html = html + '	              </tr>		';
  html = html + '	            </table></td>		';
  ...
  html = html + '	                  Versand<br>inkl. MwSt.</td>		';
  ...
  html = html + '	                  <span class="desktopHide" style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;">Versand: </span><span class="amount" style="color: #242424;">' + inputData.orderShippingCost + ' €</span><br>		';
  html = html + '	                  <span class="desktopHide" style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;">inkl. MwSt.: </span><span class="amount" style="color: #242424;">' + inputData.orderTaxAmount + ' €</span></td>		';
  html = html + '	              </tr>		';
  html = html + '	              <tr>		';
  ...
  html = html + '	        </tr>		';
  html = html + '	        <tr>		';
  html = html + '	          <td class="eFooter" style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 0;padding-top: 14px;padding-bottom: 0;padding-left: 0;padding-right: 0;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;text-align: left;font-size: 12px;line-height: 21px;width: 544px;color: #b2b2b2;">Impressum<br>		';
  html = html + '	            <a href="#" class="highFix" style="padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;color: #b2b2b2;cursor: pointer;"><span style="text-decoration: none;color: #b2b2b2;cursor: pointer;">' + inputData.orderLegalImprint + '</span></a></td>		';
  html = html + '	        </tr>		';
  html = html + '	        <tr>		';
  html = html + '	          <td class="eFooter" style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 0;padding-top: 14px;padding-bottom: 0;padding-left: 0;padding-right: 0;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;text-align: left;font-size: 12px;line-height: 21px;width: 544px;color: #b2b2b2;">Widerufsbelehrung<br>		';
  ...
  html = html + '	        </tr>		';
  html = html + '	        <tr>		';
  html = html + '	          <td class="eFooter" style="margin-top: 0;margin-left: 0;margin-right: 0;margin-bottom: 0;padding-top: 14px;padding-bottom: 0;padding-left: 0;padding-right: 0;border-collapse: collapse;border-spacing: 0;-webkit-text-size-adjust: none;font-family: Arial, Helvetica, sans-serif;text-align: left;font-size: 12px;line-height: 21px;width: 544px;color: #b2b2b2;">Allgemeine Geschäftsbedingungen<br>		';
