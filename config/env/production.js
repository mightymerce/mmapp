...
module.exports = {
  ...
  db: {
    uri: 'mongodb://mmdb:umsnJG2uXCDV@ec2-52-73-221-95.compute-1.amazonaws.com:27017/mmdb',
  ...
  mailer: {
    from: process.env.MAILER_FROM || 'Mightymermerce | <noreply@mightymerce.com>',
    options: {
      service: process.env.MAILER_SERVICE_PROVIDER || 'gmail',
      auth: {
        user: process.env.MAILER_EMAIL_ID || 'wagner@mightymerce.com',
        pass: process.env.MAILER_PASSWORD || 'pufyeytpdejudtfk'
      }
    }
  },
  seedDB: {
